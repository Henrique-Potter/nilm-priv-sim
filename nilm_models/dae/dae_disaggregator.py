    ...
    def train(self, mains, meter, epochs=1, batch_size=16, **load_kwargs):
        ...
        **load_kwargs : keyword arguments passed to `meter.power_series()`
        ...
        while(run):
            ...
            total_size_main += len(mainchunk)
            total_target += len(mainchunk)
        ...
        print("Size of the main: {}".format(len(mainchunk)))
        print("Size of the meter target: {}".format(len(meterchunk)))
