...
from nilm_models.w_gru.windowgrudisaggregator import WindowGRUDisaggregator
...
rnn = WindowGRUDisaggregator(window_size=50)

if not Path("model-redd5.h5").exists():
    rnn.train(train_mains, train_meter, epochs=2, sample_period=1)
